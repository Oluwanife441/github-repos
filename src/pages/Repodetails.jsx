...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Oluwanife441/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Oluwanife441/${id}/branches`)
      .then((response) => response.json())
      .then((data) => {
        setBranch(data);
      });
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Oluwanife441/${id}/deployments`)
      .then((response) => response.json())
      .then((data) => {
        setDeployment(data);
      });
      ...
      <div className="repodetail-card">
        ...
        <p>
          ...
          {deployment.length === 0 ? (
            ...
            <a href={`https://Oluwanife441.github.io/${details.name}`}>
              Oluwanife441.github.io/{details.name}
            </a>
          )}
        </p>
        <p>
